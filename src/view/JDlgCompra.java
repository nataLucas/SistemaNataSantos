...
public class JDlgCompra extends javax.swing.JDialog {
    ...
    /**
     * Creates new form JDçgNlcCompra
     */
    public JDlgCompra(java.awt.Frame parent, boolean modal) {
       super(parent, modal);
        initComponents();
        setTitle("Lista de NlcCompra");
        ...
        for (int i = 0; i < lista.size(); i++) {
            jCboClientes.addItem((NlcClientes) lista.get(i)); 
        }
        
        VendedorDao funcionarioDAO = new VendedorDao();
        List lista2 = (List) funcionarioDAO.listAll();
        for (int i = 0; i < lista2.size(); i++) {
            jCboFuncionario.addItem((NlcVendedor) lista2.get(i)); 
        }
    
        
    }
    public NlcCompra viewBean(){
        NlcCompra Compra = new NlcCompra();
        Compra.setNlcIdCompra(Util.strToInt(jTxtCodigo.getText()));
        Compra.setNlcUsuarios((NlcUsuarios)jCboClientes.getSelectedItem());
        Compra.setNlcVendedor((NlcVendedor)jCboFuncionario.getSelectedItem());
        Compra.setNlcStatus(jCboTipo.getSelectedIndex());
        Compra.setNlcFormaPagamento(jCboFormaDePagamento.getSelectedIndex());
        Compra.setNlcDataPagamento(Util.strToDate(jFmtData.getText()));
        Compra.setNlcTotal(Util.strToDouble(jTxtTotal.getText()));
        return Compra;
    }
    
    public void beanView(NlcCompra Compra){
        jTxtCodigo.setText(Util.intToStr(Compra.getNlcIdCompra())); 
        jCboFormaDePagamento.setSelectedIndex(Compra.getNlcFormaPagamento());
        jCboTipo.setSelectedIndex(Compra.getNlcStatus());
        jFmtData.setText(Util.dateToStr(Compra.getNlcDataPagamento()));
        jTxtTotal.setText(Util.doubleToStr(Compra.getNlcTotal()));
    ...
    private void initComponents() {
        ...
        jCboClientes = new javax.swing.JComboBox<NlcClientes>();
        jLabel4 = new javax.swing.JLabel();
        jCboFuncionario = new javax.swing.JComboBox<NlcVendedor>();
        ...
        jCboFormaDePagamento = new javax.swing.JComboBox<>();
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(jCboFormaDePagamento, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(54, 54, 54)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(jFmtData, javax.swing.GroupLayout.PREFERRED_SIZE, 67, javax.swing.GroupLayout.PREFERRED_SIZE)
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(jCboClientes, javax.swing.GroupLayout.PREFERRED_SIZE, 116, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(jLabel4)
                            .addComponent(jCboFuncionario, javax.swing.GroupLayout.PREFERRED_SIZE, 83, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                .addGap(35, 35, 35)
    ...
    private void jBtnPesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnPesquisarActionPerformed
        ...
        JDlgComprasPesquisar jDlgCompraPesquisar = new JDlgComprasPesquisar(null, true);
    ...
    private void jBtnIncluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnIncluirActionPerformed
        // TODO add your handling code here:
//
    Util.habilitar(true, jTxtCodigo, jCboClientes, jCboFuncionario, jCboFormaDePagamento, jCboTipo,jFmtData,jTxtTotal, jBtnConfirmar, jBtnCancelar);
    Util.habilitar(false, jBtnAlterar, jBtnExcluir, jBtnIncluir, jBtnPesquisar,jBtnIncluirProd,jBtnExcluirProd,jBtnAlterarProd);
    ...
    private void jBtnAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnAlterarActionPerformed
        // TODO add your handling code here:
        Util.habilitar(true, jFmtData, jTxtTotal, jCboFormaDePagamento, jCboTipo, jBtnConfirmar, jBtnCancelar);
        Util.habilitar(false, jBtnAlterar, jBtnExcluir, jBtnIncluir, jBtnPesquisar);
        jFmtData.grabFocus();
        incluir = false;
   ...
   Util.limpar(jTxtCodigo, jCboFormaDePagamento, jCboTipo, jCboClientes,jCboFuncionario, jFmtData, jTxtTotal);        jTxtCodigo.grabFocus();
    ...
    private void jBtnConfirmarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnConfirmarActionPerformed
       ...
       CompraDao CompraDao = new CompraDao();
            if (incluir == true){
               CompraDao.insert(viewBean());
            }else{
                CompraDao.update(viewBean());
            }
            CompraDao.insert(viewBean());
        Util.habilitar(true, jTxtCodigo, jTxtTotal,jFmtData, jCboFuncionario, jCboClientes,jCboFormaDePagamento,jCboTipo,jBtnConfirmar,jBtnCancelar);
    ...
    private void jBtnIncluirProdActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnIncluirProdActionPerformed
        // TODO add your handling code here:
        JDlgComprasProdutos jDlgNlcCompraProdutos = new JDlgComprasProdutos(null,true);
        jDlgNlcCompraProdutos.setVisible(true);
    ...
    private javax.swing.JComboBox<NlcClientes> jCboClientes;
    private javax.swing.JComboBox<String> jCboFormaDePagamento;
    private javax.swing.JComboBox<NlcVendedor> jCboFuncionario;
